...
<script>
  ...
  export default {
    ...
    mounted() {
      const that = this;
      console.log('that.$refs.activities.offsetHeight', that.$refs.activities.offsetHeight);
      console.log('window.innerHeight - 46', window.innerHeight - 46);
      if ( that.$refs.activities.offsetHeight + 50 > window.innerHeight - 46 ) {
